...
- 2026-08-09 回归：Core 测试 65/65 通过；Release 构建 0 警告、0 错误。
- 最终自包含发布目录共 482 个文件、257,980,347 字节，Spotify/WebView2 文件为 0；安装后 EXE 哈希与发布产物一致。
- 最终安装版成功连接 Apple Music 并为 `only my railgun` 装载 60 行同源人工歌词；二次启动后仍只有一个进程，运行日志无新增错误。
